                ...
                <div className="mx-auto max-w-[1000px]">
                    ...
                    <div className="flex flex-col gap-8 lg:gap-10">
                        {experiences.map((exp) => (
                            <div
                                key={exp._id}
                                className="group flex flex-col overflow-hidden rounded-2xl bg-white p-4 shadow-xl md:flex-row md:items-stretch lg:rounded-3xl lg:p-5"
                            >
                                {/* Image Section */}
                                <div className="relative aspect-[4/3] w-full overflow-hidden rounded-xl md:aspect-auto md:w-[32%] md:rounded-2xl lg:w-[35%] lg:rounded-3xl">
                                    <Image
                                ...
                                <div className="mt-4 flex flex-1 flex-col justify-between rounded-xl bg-[#00843d] p-5 text-white md:ml-5 md:mt-0 lg:ml-6 lg:rounded-3xl lg:p-6">
