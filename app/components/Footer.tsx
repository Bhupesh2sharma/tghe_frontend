...
function FooterColumn({
  ...
  return (
    <div className="flex flex-col">
      <h3 className="text-base font-black uppercase tracking-widest text-white lg:text-lg">
        {title}
      </h3>
      <div className="mt-4 mb-6 h-[1.5px] w-full bg-white/20" aria-hidden />
      {children}
    </div>
  );
}
...
export default function Footer() {
  return (
    <footer className="relative w-full bg-[#ff4106] pt-12">
      <div className="mx-3 rounded-t-[40px] bg-[#00843d] px-8 py-16 sm:mx-6 sm:px-12 md:mx-10 md:px-16 lg:mx-12 lg:px-20">
        <div className="mx-auto max-w-[1400px]">
          <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-5">
            ...
            <div className="flex flex-col sm:col-span-2 lg:col-span-1">
              <Link href="/" className="flex flex-col items-start text-white">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    <span className="text-xl font-black leading-[1.1] md:text-2xl">
                      THE GREAT<br />HIMALAYAN<br />ESCAPE
                    </span>
                  </div>
                </div>
                <p className="mt-4 text-xs font-semibold leading-relaxed tracking-wider opacity-90 md:text-sm">
              ...
              <ul className="flex flex-col gap-4">
                {legalLinks.map(({ label, href }) => (
                  <li key={href}>
                    <Link
                      href={href}
                      className="text-sm font-bold text-white transition-opacity hover:opacity-80 md:text-base"
                    >
                      {label}
                    </Link>
                  </li>
            ...
            <FooterColumn title="CONTACT US">
              <ul className="flex flex-col gap-4 text-sm font-bold text-white md:text-base">
                <li>
          ...
          {/* Copyright Area */}
          <div className="mt-20 flex flex-col items-center justify-center border-t border-white/10 pt-10 text-center">
            <p className="max-w-2xl text-[10px] font-bold tracking-widest text-white/80 uppercase md:text-xs">
